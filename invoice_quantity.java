...
public class invoice_quantity {

   
    public static void main(String[] args) {
    invoiceitem obj = new invoiceitem("priya","apple",10,250);//creating object for class invoiceitem
    ...
    obj.setQty(5);//calling method setqty
    obj.setunitprice(300);//calling method setunitprice
